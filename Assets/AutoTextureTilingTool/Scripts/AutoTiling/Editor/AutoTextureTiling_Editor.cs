                                ...
                                case Tool.Move:
                                    ...
                                    switch (TextureTilingEditorWindow.currentSelectedFace) {
                                        case Direction.Back:
                                            ...
                                            if (ATTHandles.TextureAlignHandle(handlePosition + (TextureTilingEditorWindow.selected.transform.rotation * Vector3.up * (att.transform.lossyScale.y / 2f)), TextureTilingEditorWindow.selected.transform.rotation * rotationToCurrentSide, sizeModifier * 0.1f, Handles.CubeCap)) {
                                                att.AlignOffsetTop(TextureTilingEditorWindow.currentSelectedFace);
                                            }
                                            if (ATTHandles.TextureAlignHandle(handlePosition + (TextureTilingEditorWindow.selected.transform.rotation * Vector3.down * (att.transform.lossyScale.y / 2f)), TextureTilingEditorWindow.selected.transform.rotation * rotationToCurrentSide, sizeModifier * 0.1f, Handles.CubeCap)) {
                                                att.AlignOffsetBottom(TextureTilingEditorWindow.currentSelectedFace);
                                            }
                                            if (ATTHandles.TextureAlignHandle(handlePosition + (TextureTilingEditorWindow.selected.transform.rotation * Vector3.left * (att.transform.lossyScale.x / 2f)), TextureTilingEditorWindow.selected.transform.rotation * rotationToCurrentSide, sizeModifier * 0.1f, Handles.CubeCap)) {
                                                att.AlignOffsetLeft(TextureTilingEditorWindow.currentSelectedFace);
                                            }
                                            if (ATTHandles.TextureAlignHandle(handlePosition + (TextureTilingEditorWindow.selected.transform.rotation * Vector3.right * (att.transform.lossyScale.x / 2f)), TextureTilingEditorWindow.selected.transform.rotation * rotationToCurrentSide, sizeModifier * 0.1f, Handles.CubeCap)) {
                                        ...
                                        case Direction.Down:
                                            ...
                                            Handles.color = Color.white;
                                            if (ATTHandles.TextureAlignHandle(handlePosition + (TextureTilingEditorWindow.selected.transform.rotation * Vector3.forward * (att.transform.lossyScale.z / 2f)), TextureTilingEditorWindow.selected.transform.rotation * rotationToCurrentSide, sizeModifier * 0.1f, Handles.CubeCap)) {
                                                att.AlignOffsetLeft(TextureTilingEditorWindow.currentSelectedFace);
                                            }
                                            if (ATTHandles.TextureAlignHandle(handlePosition + (TextureTilingEditorWindow.selected.transform.rotation * Vector3.back * (att.transform.lossyScale.z / 2f)), TextureTilingEditorWindow.selected.transform.rotation * rotationToCurrentSide, sizeModifier * 0.1f, Handles.CubeCap)) {
                                                att.AlignOffsetRight(TextureTilingEditorWindow.currentSelectedFace);
                                            }
                                            if (ATTHandles.TextureAlignHandle(handlePosition + (TextureTilingEditorWindow.selected.transform.rotation * Vector3.left * (att.transform.lossyScale.x / 2f)), TextureTilingEditorWindow.selected.transform.rotation * rotationToCurrentSide, sizeModifier * 0.1f, Handles.CubeCap)) {
                                                att.AlignOffsetBottom(TextureTilingEditorWindow.currentSelectedFace);
                            ...
                            if (TextureTilingEditorWindow.currentSelectedFaceIndex >= 0 && TextureTilingEditorWindow.currentSelectedFaceIndex < TextureTilingEditorWindow.selected.faceUnwrapData.Length) {
                                ...
                                switch (TextureTilingEditorWindow.currentTextureTool) {
                                    case Tool.Move:
                                        ...
                                        Handles.color = Color.red;
                                        amountX =
                                            ATTHandles.TexturePositionHandle(center, completeSideRotation * Quaternion.AngleAxis(270f + selectedFace.rotation, Vector3.up), sizeModifier, Handles.ArrowCap);
                                        Handles.color = Color.blue;
                                        amountY =
                                            ATTHandles.TexturePositionHandle(center, completeSideRotation * Quaternion.AngleAxis(180f + selectedFace.rotation, Vector3.up), sizeModifier, Handles.ArrowCap);
                                        if (EditorGUI.EndChangeCheck()) {
                                            changedAnything = true;
                                        ...
                                        Handles.color = Color.blue;
                                        if (ATTHandles.TextureAlignHandle(center, completeSideRotation, sizeModifier * 0.1f, Handles.CubeCap)) {
                                        ...
                                        Handles.color = Color.white;
                                        if (ATTHandles.TextureAlignHandle(center + (completeSideRotation * Vector3.back * (faceBounds.height / 2f)), completeSideRotation, sizeModifier * 0.1f, Handles.CubeCap)) {
                                            TextureTilingEditorWindow.selected.AlignOffsetTop(TextureTilingEditorWindow.currentSelectedFaceIndex);
                                        }
                                        if (ATTHandles.TextureAlignHandle(center + (completeSideRotation * Vector3.forward * (faceBounds.height / 2f)), completeSideRotation, sizeModifier * 0.1f, Handles.CubeCap)) {
                                            TextureTilingEditorWindow.selected.AlignOffsetBottom(TextureTilingEditorWindow.currentSelectedFaceIndex);
                                        }
                                        if (ATTHandles.TextureAlignHandle(center + (completeSideRotation * Vector3.left * (faceBounds.width / 2f)), completeSideRotation, sizeModifier * 0.1f, Handles.CubeCap)) {
                                            TextureTilingEditorWindow.selected.AlignOffsetLeft(TextureTilingEditorWindow.currentSelectedFaceIndex);
                                        }
                                        if (ATTHandles.TextureAlignHandle(center + (completeSideRotation * Vector3.right * (faceBounds.width / 2f)), completeSideRotation, sizeModifier * 0.1f, Handles.CubeCap)) {
                                    ...
                                    case Tool.Scale:
                                        ...
                                        Handles.color = Color.white;
                                        scaleAmount =
                                            ATTHandles.TextureScaleHandle(center, completeSideRotation * Quaternion.AngleAxis(225f + selectedFace.rotation, Vector3.up), sizeModifier * 0.1f, Handles.CubeCap);
                                        Handles.color = Color.red;
                                        amountX =
                                            ATTHandles.TextureScaleHandle(center, completeSideRotation * Quaternion.AngleAxis(270f + selectedFace.rotation, Vector3.up), sizeModifier * 0.1f, Handles.CubeCap);
                                        Handles.color = Color.blue;
                                        amountY =
                                            ATTHandles.TextureScaleHandle(center, completeSideRotation * Quaternion.AngleAxis(180f + selectedFace.rotation, Vector3.up), sizeModifier * 0.1f, Handles.CubeCap);
                                        if (EditorGUI.EndChangeCheck()) {
                                            changedAnything = true;
                                            if (scaleAmount != 0f) {
