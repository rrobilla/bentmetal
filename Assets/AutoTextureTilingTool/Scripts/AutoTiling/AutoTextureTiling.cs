    ...
    public class FaceData {
        ...
        public void AddTriangle(int[] triangleVertexIndices, Vector3 normal) {
            ...
            if (triangleVertexIndices == null) {
                Debug.LogError(GetType() + ".AddVertex: triangleVertexIndices was null.");
                return;
            }
            if (triangleVertexIndices.Length != 3) {
                Debug.LogError(GetType() + ".AddVertex: triangle vertex index array has to have exactly 3 entries.");
                return;
            }
            ...
            for (int i = 0; i < triangles.Length; i += 3) {
                ...
                if (sameIndexCount == 3) {
                    Debug.LogWarning(GetType() + ".AddVertex: triangle " + triangleVertexIndices[0] + "|" + triangleVertexIndices[1] + "|" + triangleVertexIndices[2] + " already existed. Check your meshData.");
                    return;
                }
            }
